            ...
            templates.get('book')
                .then(function (template) {
                    ...
                    $(function () {
                        ...
                        if (user != null) { //if user login
                            if (ratingsExists == true) { //if it has ratings
                                if (userVote == undefined) { //if user doesn`t vote yet
                                    $('.your-rating').hide();
                                    $('#example' + review_id).barrating({
                                        theme: 'fontawesome-stars',
                                        showSelectedRating: true,
                        ...
                        } else { //if user dosen`t logged in
                            $('.your-rating').hide();
                            $('.tooltiptext').hide();
                            $('#example' + review_id).barrating({
                                theme: 'fontawesome-stars',
